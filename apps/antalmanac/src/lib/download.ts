 ...
 */
export function getByDays(days: string) {
 ...
 */
export function getClassStartDate(term: string, bydays: ReturnType<typeof getByDays>) {
 ...
 */
export function getFirstClass(date: YearMonthDay, time: string): [DateTimeArray, DateTimeArray] {
 ...
 */
export function getExamTime(exam: string, year: number) {
 ...
 */
export function parseTimes(time: string) {
